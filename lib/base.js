...
var logger = log4js.getLogger(config.log4js.category);

exports.log = function log(app){
    app.use(log4js.connectLogger(logger));
}
global.logger = exports.logger = logger;
global.requireJsonFormat = exports.requireJsonFormat = function requireJsonFormat(req,res,next){
